...
class ComplexAndroidTests(unittest.TestCase):
    def setUp(self):
        ...
        desired_caps['app'] = PATH(
            'E:/tjl个人/study/auto/appium/ApiDemos-debug.apk'
        )
    ...
    '''def test_find_elements(self):
        ...
        self.assertEqual('Accessibility', els[1].text)
    ...
    def test_smiley_face(self):
        ...
        print(111)
        e1 = TouchAction()
        e1.press(x=150, y=500).release()
        print(222)

        e2 = TouchAction()
        e2.press(x=250, y=500).release()

        smile = TouchAction()
        smile.press(x=110, y=600) \
            .move_to(x=1, y=1) \
            .move_to(x=1, y=1) \
            .move_to(x=1, y=1) \
            .move_to(x=1, y=1) \
