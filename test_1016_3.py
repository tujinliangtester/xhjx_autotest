...
class ContactsAndroidTests(unittest.TestCase):
    def setUp(self):
        ...
        desired_caps['app'] = PATH(
            'E:/tjl个人/study/auto/appium/ContactManager.apk'
        )
        '''
    ...
    def test_add_contacts(self):
        # el2=self.driver.find_element_by_accessibility_id('aaa')
        # el2.click()
        el = self.driver.find_element_by_accessibility_id("Add Contact")
        el.click()

        textfields = self.driver.find_elements_by_class_name("android.widget.EditText")
        textfields[0].send_keys("App")
        textfields[2].send_keys("some")
        ...
        el3=self.driver.find_element_by_accessibility_id('App')
