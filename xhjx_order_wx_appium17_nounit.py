...
class orderTest():
    ...
    def preforweb(self):
        sleep(2)
        el = self.driver.find_element_by_id('com.tencent.mm:id/apx')  # huawei
        # el = self.driver.find_elements_by_id('com.tencent.mm:id/apt')#oppo
        # el1=el[1]
        el.click()

        sleep(2)
        el = self.driver.find_elements_by_id('com.tencent.mm:id/aas')[1]
        el.click()
        ...
        # wo de
        el = self.driver.find_element_by_xpath('//*[@id="app"]/div/footer/div[2]/a[2]')
        el.click()
...
if __name__=='__main__':
    ...
    while flag==0:
        try:
            ...
            shopcar_goodsname='tjl'
            ot.addshopcar()
            shopcar_goodsname='订单'
            ot.addshopcar()

            ot.shopcar_buy()
            #out shop
            username='12358580012'
            try:
                ot.logout()
            except:
                print('logout erro')
            ot.login()
            ot.wd_to_cms()
            ot.test_user_order_checkoutorder()
            flag=1

        except :
            xhjx_cms_order.cmsdriver.quit()
            print('erro')
            print(Exception)
            i=i+1
            print(i)
